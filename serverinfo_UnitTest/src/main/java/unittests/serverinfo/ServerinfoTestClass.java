/*
 * ServerinfoTestClass
 * Test generated by Generator  on Mar 30, 2023 8:28:34 AM
 */
package unittests.serverinfo;
...
public class ServerinfoTestClass {
    ...
    @Test
    public void serverinfo_serverinfo_getServerInfo_BuildBasicResponse_TestCase_001() throws TestException {

        // Define the SpyObjectReference
        SpyObjectReference nodeReference = new SpyObjectReference().application("serverinfo").messageFlow("serverinfo.getServerInfo").node("BuildBasicResponse");   
        ...
        try {
            String messageAssemblyPath = "/000026F8-6425AA27-00000001-1.mxml";
        ...
        try {
            ...
            String messageAssemblyPath = "/000026F8-6425AA27-00000001-2.mxml";
            InputStream messageStream = Thread.currentThread().getContextClassLoader().getResourceAsStream(messageAssemblyPath);
            if (messageStream == null)
            {
                throw new TestException("Unable to locate message assembly file: " + messageAssemblyPath);
            ...
            assertThat(actualMessageAssembly, equalsMessage(expectedMessageAssembly)
				.ignorePath("/Message/XMLNSC/ACE/ServerInfo/ExecutionGroupName", true));
    ...
    @Test
    public void serverinfo_serverinfo_getServerInfo_BuildPerformanceResponse_TestCase_001() throws TestException {

        // Define the SpyObjectReference
        SpyObjectReference nodeReference = new SpyObjectReference().application("serverinfo").messageFlow("serverinfo.getServerInfo").node("BuildPerformanceResponse");   
        ...
        // Create a Message Assembly from the input data file
        try {
            String messageAssemblyPath = "/000026F8-6425AA2E-00000002-1.mxml";
            InputStream messageStream = Thread.currentThread().getContextClassLoader().getResourceAsStream(messageAssemblyPath);
            if (messageStream == null)
            {
                throw new TestException("Unable to locate message assembly file: " + messageAssemblyPath);
        ...
        try {
            ...
            // Create a Message Assembly from the expected output mxml resource
            String messageAssemblyPath = "/000026F8-6425AA2E-00000002-2.mxml";
            InputStream messageStream = Thread.currentThread().getContextClassLoader().getResourceAsStream(messageAssemblyPath);
            if (messageStream == null)
            {
                throw new TestException("Unable to locate message assembly file: " + messageAssemblyPath);
    ...
    @Test
    public void serverinfo_serverinfo_getServerInfo_CheckInput_TestCase_001() throws TestException {

        // Define the SpyObjectReference
        SpyObjectReference nodeReference = new SpyObjectReference().application("serverinfo").messageFlow("serverinfo.getServerInfo").node("CheckInput");   
        ...
        // Create a Message Assembly from the input data file
        try {
            String messageAssemblyPath = "/000026F8-6425AA27-00000001-0.mxml";
            InputStream messageStream = Thread.currentThread().getContextClassLoader().getResourceAsStream(messageAssemblyPath);
            if (messageStream == null)
            {
                throw new TestException("Unable to locate message assembly file: " + messageAssemblyPath);
    ...
    @Test
    public void serverinfo_serverinfo_getServerInfo_CheckInput_TestCase_002() throws TestException {
        ...
        // Create a Message Assembly from the input data file
        try {
            String messageAssemblyPath = "/000026F8-6425AA2E-00000002-0.mxml";
            InputStream messageStream = Thread.currentThread().getContextClassLoader().getResourceAsStream(messageAssemblyPath);
            if (messageStream == null)
            {
                throw new TestException("Unable to locate message assembly file: " + messageAssemblyPath);
